		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "display employee details in simple form and simple form with sub groups",
									"targetURL": "#r3simpleformlayout-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"r3simpleformlayout-display": {
								"semanticObject": "r3simpleformlayout",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=r3simpleformlayout",
									"url": sap.ui.require.toUrl("r3simpleformlayout")
								}
							}
						}
					}
